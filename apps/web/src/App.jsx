  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        {/* Hero Section */}
        <section className="relative min-h-[82vh] flex items-center justify-center overflow-hidden bg-[#17100c]">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-14 md:py-16">
            <motion.h1 
        ...
        <section id="shop" className="py-12 md:py-16 bg-muted/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
        ...
        <section id="gift-boxes" className="py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="relative aspect-[5/4] rounded-2xl overflow-hidden shadow-soft-lg"
              >
                <img 
              ...
              <motion.div
                ...
                transition={{ duration: 0.6 }}
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-3">The Evening Ritual Box</h2>
                <p className="text-xl text-primary font-medium mb-4">From $119</p>
        ...
        <section id="custom-gifting" className="py-12 md:py-16 bg-muted/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-center mb-8"
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-3">Custom Gifting</h2>
        ...
        <section className="py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              className="text-center mb-8"
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-3">Ecommerce Features</h2>
              <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 max-w-5xl mx-auto"
            >
        ...
        {/* Journal Section */}
        <section id="journal" className="py-12 md:py-16 bg-muted/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-center mb-8"
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-3">Journal</h2>
              <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
        ...
        <section className="py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              className="text-center"
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-3">Example customer feedback layout</h2>
              <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
